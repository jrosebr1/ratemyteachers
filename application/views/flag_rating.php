...
<html>
	<head>
		...
		<title>Flag a Rating | <?php echo $this->config->item("core.sitename"); ?></title>
	...
	<body>
		...
		<h1>Flag <?php echo $person_name; ?>'s Rating on <?php echo $rating_date; ?></h1>
		...
		<p>
			<form id="flag_rating" action="/flag_rating" method="post">
				After reading the rules above, please tell us why you are flagging this rating.<br>
				<div> 
				...
				<input type="submit" value="Flag This Rating">
			</form>
		</p>
		...
		<script type="text/javascript">
			window.addEvent("domready", function(event){
				...
				flagForm = new AJAX_Form({
					...
					"error_msg": "It looks like an error has occurred. Please try flagging the rating again in a few minutes."
				});
				...
				$("flag_rating").addEvent("submit", function(event){
